...
var numCorrect = 0;
var totalReward = 0; // New variable to track the total reward
...
function updateScores(correctGuess) {
    if (correctGuess) {
        numCorrect++;
        // Add the reward when the guess is correct
        totalReward += 10; // Change the amount as needed
    }
...
function modifyCardGameHTML(correctGuess) {
    ...
    scoreHTML.innerText = "You've got " + numCorrect + "/" + numQuestionsAsked + " correct. Total Reward: €" + totalReward;
}
